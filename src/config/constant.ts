...
export const AURORA_RELEASES_API_BASE_URL = `https://api.github.com/repos/${AURORA_GITHUB_REPOSITORY}/releases`
export const AURORA_RELEASES_API_URL = `${AURORA_RELEASES_API_BASE_URL}/latest`
